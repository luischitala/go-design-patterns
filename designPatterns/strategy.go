...
//Create a new struct password protector
...
//Simulating the hash algorithms
type SHA struct{}
...
func main() {
	...
	passwordProtector := NewPasswordProtector("Luis", "gmail password", sha)
